...
char * WrapIvecFunctions(char * source, int * sourceLength){
    ...
    source = WrapFunction(source, sourceLength, "textureOffset", "vgpu_textureOffset", "\nvec4 vgpu_textureOffset(sampler2D tex, vec2 P, vec2 offset){return textureOffset(tex, P, offset, 0.0);}\n"
                                                                                       ...
                                                                                       "vec4 vgpu_textureOffset(sampler3D tex, vec3 P, vec3 offset){return textureOffset(tex, P, offset, 0.0);}\n"
                                                                                       ...
                                                                                       "float vgpu_textureOffset(sampler2DShadow tex, vec3 P, vec2 offset){return textureOffset(tex, P, offset, 0.0);}\n"
                                                                                       ...
                                                                                       "vec4 vgpu_textureOffset(sampler2DArray tex, vec3 P, vec2 offset){return textureOffset(tex, P, offset, 0.0);}\n"
